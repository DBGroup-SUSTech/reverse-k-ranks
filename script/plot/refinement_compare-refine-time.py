...
def plot_figure(*, fname: str, dataset_name: str, ylim: list, yticks: list,
    ...
    if test:
        plt.savefig("refinement_compare-refine-time_{}.jpg".format(dataset_name), bbox_inches='tight', dpi=600)
    else:
        plt.savefig("refinement_compare-refine-time_{}.pdf".format(dataset_name), bbox_inches='tight')
...
if __name__ == "__main__":
    ...
    fname_l = ['./data/refinement_compare/Yelp-refine-time.csv',
               './data/refinement_compare/Amazon-refine-time.csv', ]
