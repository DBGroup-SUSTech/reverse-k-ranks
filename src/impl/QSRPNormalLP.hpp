//
// Created by bianzheng on 2023/5/4.
//

#ifndef REVERSE_KRANKS_QSRPNORMALLP_HPP
#define REVERSE_KRANKS_QSRPNORMALLP_HPP
...
namespace ReverseMIPS::QSRPNormalLP {
...
//                }
    ...
    BuildIndex(const VectorMatrix &data_item, const VectorMatrix &user, const char *dataset_name,
               const int &n_sample, const int &n_sample_query, const int &sample_topk, const int &n_thread, const char *index_basic_dir) {
        ...
        const std::string method_name = "QSRPNormalLP";
...
#endif //REVERSE_KRANKS_QSRPNORMALLP_HPP
