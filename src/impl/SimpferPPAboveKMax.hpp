...
#ifndef REVERSE_KRANKS_SIMPFERPPABOVEKMAX_HPP
#define REVERSE_KRANKS_SIMPFERPPABOVEKMAX_HPP
...
namespace ReverseMIPS::SimpferPPAboveKMax {
        ...
        Retrieval(const VectorMatrix &query_item, const int &topk, const int &n_execute_query,
            ...
            for (int queryID = 0; queryID < n_query_item; queryID++) {
                ...
                while (rtk_topk <= n_data_item_) {
                    simpfer_index_.SimpferPPAboveKMax(query_sd_l[queryID], user_matrix_, rtk_topk,
                                                      result_userID_l,
...
#endif //REVERSE_KRANKS_SIMPFERPPABOVEKMAX_HPP
