...
#ifndef REVERSE_KRANKS_QSRPUNIFORMLP_HPP
#define REVERSE_KRANKS_QSRPUNIFORMLP_HPP
...
namespace ReverseMIPS::QSRPUniformLP {
    ...
    class Index : public BaseIndex {
        ...
        //rank bound search
        UniformLinearRegressionLP rank_bound_ins_;
        //rank search
    ...
    public:
        ...
        Index(
                ...
                UniformLinearRegressionLP &rank_bound_ins,
                //rank search
...
//                }
    ...
    BuildIndex(const VectorMatrix &data_item, const VectorMatrix &user, const char *dataset_name,
        ...
        const std::string method_name = "QSRPUniformLP";
        ...
        UniformLinearRegressionLP rank_bound_ins(index_basic_dir, dataset_name, regression_index_name, n_sample,
                                                 n_sample_query,
                                                 sample_topk);
...
#endif //REVERSE_KRANKS_QSRPUNIFORMLP_HPP
