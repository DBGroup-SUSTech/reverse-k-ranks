...
#ifndef REVERSE_KRANKS_QSRPUNIFORMCANDIDATENORMALLP_HPP
#define REVERSE_KRANKS_QSRPUNIFORMCANDIDATENORMALLP_HPP
...
namespace ReverseMIPS::QSRPUniformCandidateNormalLP {
...
//                }
    ...
    BuildIndex(const VectorMatrix &data_item, const VectorMatrix &user, const char *dataset_name,
        ...
        const std::string method_name = "QSRPUniformCandidateNormalLP";
...
#endif //REVERSE_KRANKS_QSRPUNIFORMCANDIDATENORMALLP_HPP
