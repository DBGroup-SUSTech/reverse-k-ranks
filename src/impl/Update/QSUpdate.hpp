//
// Created by bianzheng on 2023/6/26.
//

#ifndef REVERSE_KRANKS_QSUPDATE_HPP
#define REVERSE_KRANKS_QSUPDATE_HPP
...
namespace ReverseMIPS::QSUpdate {
...
//        ip_bound_ins.Preprocess(svd_ins.transfer_user_);
        ...
        std::unique_ptr<Index> index_ptr = std::make_unique<Index>(rank_ins,
                                                                   disk_ins, user, data_item,
                                                                   n_thread);
        return index_ptr;
    }

}
#endif //REVERSE_KRANKS_QSUPDATE_HPP
