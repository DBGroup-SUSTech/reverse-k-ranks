...
#ifndef REVERSE_KRANKS_QUERYRANKSAMPLECOMPUTEALLGPU_HPP
#define REVERSE_KRANKS_QUERYRANKSAMPLECOMPUTEALLGPU_HPP

#include "alg/SpaceInnerProduct.hpp"
#include "alg/TopkMaxHeap.hpp"
#include "ComputeAllGPU.hpp"
...
namespace ReverseMIPS::QueryRankSampleComputeAllGPU {
        ...
        Retrieval(const VectorMatrix &query_item, const int &topk, const int &n_execute_query,
            ...
            for (int queryID = 0; queryID < n_query_item; queryID++) {
                ...
                disk_ins_.GetRank(user_, data_item_, queryIP_l_, prune_l_, result_l_,
                                  topk - n_result_user, refine_ip_cost, n_refine_user, tmp_refine_user_time);
    ...
    BuildIndex(VectorMatrix &data_item, VectorMatrix &user, const char *index_path, const char *dataset_name,
        ...
        ComputeAllGPU disk_ins(user, data_item);
...
#endif //REVERSE_KRANKS_QUERYRANKSAMPLECOMPUTEALLGPU_HPP
