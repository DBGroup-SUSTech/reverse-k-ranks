...
#ifndef REVERSE_K_RANKS_QSRPUNIFORMCANDIDATEUNIFORM_HPP
#define REVERSE_K_RANKS_QSRPUNIFORMCANDIDATEUNIFORM_HPP
...
namespace ReverseMIPS::QSRPUniformCandidateUniform {
    ...
    BuildIndex(VectorMatrix &data_item, VectorMatrix &user, const char *dataset_name,
        ...
        const std::string index_name = IndexName("QSRPUniformCandidateUniform");
        //rank search
        SampleSearch rank_ins(index_basic_dir, dataset_name, index_name.c_str(),
                              n_sample, true, true,
                              n_sample_query, sample_topk);

        UniformLinearRegressionFast rank_bound_ins(index_basic_dir, dataset_name, "QSRPUniformCandidateUniform",
                                                   n_sample,
                                                   n_sample_query, sample_topk, epoch_rp);
...
#endif //REVERSE_K_RANKS_QSRPUNIFORMCANDIDATEUNIFORM_HPP
