...
#ifndef REVERSE_KRANKS_QSRPNORMAL_HPP
#define REVERSE_KRANKS_QSRPNORMAL_HPP
...
namespace ReverseMIPS::QSRPNormal {
...
//                spdlog::error("refine user size {}", refine_user_size);
    ...
    BuildIndex(VectorMatrix &data_item, VectorMatrix &user, const char *dataset_name,
        ...
        const std::string index_name = IndexName("QSRPNormal");
        //rank search
        ...
        NormalLinearRegressionFast rank_bound_ins(index_basic_dir, dataset_name, "QSRPNormal",
...
#endif //REVERSE_KRANKS_QSRPNORMAL_HPP
