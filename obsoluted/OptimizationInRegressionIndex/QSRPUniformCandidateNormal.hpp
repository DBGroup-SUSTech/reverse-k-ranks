...
#ifndef REVERSE_K_RANKS_QSRPUNIFORMCANDIDATENORMAL_HPP
#define REVERSE_K_RANKS_QSRPUNIFORMCANDIDATENORMAL_HPP
...
#include "alg/RegressionPruning/NormalLinearRegressionFast.hpp"
...
namespace ReverseMIPS::QSRPUniformCandidateNormal {
    ...
    class Index : public BaseIndex {
        ...
        //rank bound search
        NormalLinearRegressionFast rank_bound_ins_;
        //rank search
    ...
    public:
        ...
        Index(
                ...
                NormalLinearRegressionFast &rank_bound_ins,
                //rank search
    ...
    BuildIndex(VectorMatrix &data_item, VectorMatrix &user, const char *dataset_name,
        ...
        const std::string index_name = IndexName("QSRPUniformCandidateNormal");
        //rank search
        SampleSearch rank_ins(index_basic_dir, dataset_name, index_name.c_str(),
                              n_sample, true, true,
                              n_sample_query, sample_topk);

        NormalLinearRegressionFast rank_bound_ins(index_basic_dir, dataset_name, "QSRPUniformCandidateNormal",
...
#endif //REVERSE_K_RANKS_QSRPUNIFORMCANDIDATENORMAL_HPP
