...
#ifndef REVERSE_KRANKS_QSRPOPTHEURISTIC_HPP
#define REVERSE_KRANKS_QSRPOPTHEURISTIC_HPP
...
#include "alg/RegressionPruning/NormalLinearRegressionOptHeuristic.hpp"
...
namespace ReverseMIPS::QSRPNormalOptHeuristic {
    ...
    class Index : public BaseIndex {
        ...
        //rank bound search
        NormalLinearRegressionOptHeuristic rank_bound_ins_;
        //rank search
    ...
    public:
        ...
        Index(
                ...
                NormalLinearRegressionOptHeuristic &rank_bound_ins,
                //rank search
...
//                spdlog::error("refine user size {}", refine_user_size);
    ...
    BuildIndex(VectorMatrix &data_item, VectorMatrix &user, const char *dataset_name,
        ...
        const std::string method_name = "QSRPNormalOptHeuristic";
        ...
        NormalLinearRegressionOptHeuristic rank_bound_ins(index_basic_dir, dataset_name, method_name, n_sample,
                                                          n_sample_query,
                                                          sample_topk);
...
#endif //REVERSE_KRANKS_QSRPOPTHEURISTIC_HPP
