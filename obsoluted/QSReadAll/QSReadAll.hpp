...
#ifndef REVERSE_KRANKS_QSREADALL_HPP
#define REVERSE_KRANKS_QSREADALL_HPP
...
namespace ReverseMIPS::QSReadAll {
...
#pragma omp parallel for default(none) shared(queryIP_l_, query_vecs) num_threads(omp_get_num_procs())
                ...
                disk_ins_.GetRank(queryIP_l_, rank_lb_l_, rank_ub_l_,
                                  prune_l_, result_l_,
                                  refine_user_size, std::max(0, topk - n_result_user),
    ...
    BuildIndex(VectorMatrix &data_item, VectorMatrix &user, const char *index_path, const char *dataset_name,
        ...
        const std::string index_name = IndexName("QSReadAll");
        //rank search
...
#endif //REVERSE_KRANKS_QSREADALL_HPP
