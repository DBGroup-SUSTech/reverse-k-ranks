...
#ifndef REVERSE_KRANKS_QSRPNORMALALGLIB_HPP
#define REVERSE_KRANKS_QSRPNORMALALGLIB_HPP
...
#include "NormalLinearRegressionALGLIB.hpp"
...
namespace ReverseMIPS::QSRPNormalALGLIB {
    ...
    class Index : public BaseIndex {
        ...
        //rank bound search
        NormalLinearRegressionALGLIB rank_bound_ins_;
        //rank search
    ...
    public:
        ...
        Index(
                ...
                NormalLinearRegressionALGLIB &rank_bound_ins,
                //rank search
...
//                spdlog::error("refine user size {}", refine_user_size);
    ...
    BuildIndex(VectorMatrix &data_item, VectorMatrix &user, const char *dataset_name,
        ...
        const string method_name = "QSRPNormalALGLIB";
        ...
        NormalLinearRegressionALGLIB rank_bound_ins(index_basic_dir, dataset_name, method_name, n_sample,
                                                    n_sample_query,
                                                    sample_topk);
...
#endif //REVERSE_KRANKS_QSRPNORMALALGLIB_HPP
