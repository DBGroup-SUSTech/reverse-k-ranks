...
#include "MinMaxLinearRegression.hpp"
...
namespace ReverseMIPS::QSRP {
    ...
    public:
        ...
        std::unique_ptr<float[]> query_vecs_ptr_;//float*
        ...
        Index(
            ...
            // float* queryxxx =  new float[vec_dim_];
        }
...
//                spdlog::error("refine user size {}", refine_user_size);
    ...
    BuildIndex(VectorMatrix &data_item, VectorMatrix &user, const char *dataset_name,
        ...
        const std::string index_name = IndexName("QSRP");
        //rank search
        ...
        MinMaxLinearRegression rank_bound_ins(index_basic_dir, dataset_name, "QSRP", n_sample, n_sample_query,
                                              sample_topk);
