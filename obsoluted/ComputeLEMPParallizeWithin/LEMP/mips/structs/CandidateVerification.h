...
namespace mips {
    ...
    inline void verifyCandidates_lengthTest(const float * query, row_type numCandidatesToVerify, RetrievalArguments* arg) {
    ...
    inline void verifyCandidates_noLengthTest(const float * query, row_type numCandidatesToVerify,  RetrievalArguments* arg) {       
...
//        std::cout<<"RS: "<<arg->results.size()<<std::endl;
    ...
    inline void verifyCandidatesTopK_noLengthTest(const float * query,row_type numCandidatesToVerify, RetrievalArguments* arg) {
    ...
    inline void verifyCandidatesTopK_lengthTest(const float * query, row_type numCandidatesToVerify,  RetrievalArguments* arg) {
